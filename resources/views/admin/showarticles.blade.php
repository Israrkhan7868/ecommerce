        ...
        <div class="container-fluid page-body-wrapper">
            ...
            <div class="col-lg-12 grid-margin stretch-card">
                ...
                <div class="card">
                    ...
                    <a class="btn btn-info btn-small" href="{{url('articles')}}">Add Articles</a>
                    </div>
                    <div class="card-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td style="text-align: center;">{{$info->slug}}</td>
                                    <td style="text-align: center;">{{$info->status}}</td>
                                    <td style="text-align: center;"><img style="align-items: center;" src="articlesimage/{{$info->image}}" alt=""></td>
                                    <td style="font-size: xx-small; text-align: center;">
                                        <a class="btn btn-success btn-sm"  href="{{url('update',$info->id)}}">Update</a>
                                        <a class="btn btn-danger btn-sm"  href="{{url('deletearticle',$info->id)}}" >Delete</a>
                                    </td>
                                </tr>
                                @endforeach
